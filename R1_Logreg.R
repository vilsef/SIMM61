...
# After data wrangling steps, we finalize our variables that we will use for later analysis.
# Here, we make factors of survived, passenger class, and child variable. We also create a variable called "family
...
# What we are interested in here is the difference between group "2 members" and
# group 3 members, since this Sue and Kate missed fell out of group 3 when Leonardo
# departed Titanic
